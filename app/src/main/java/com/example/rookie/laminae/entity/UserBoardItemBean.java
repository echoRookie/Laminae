...
public class UserBoardItemBean {
    ...
    private List<UserBoardBean.BoardItemInfo.PinsSimpleBean> pins;

    public void setPins(List<UserBoardBean.BoardItemInfo.PinsSimpleBean> pins) {
        this.pins = pins;
    }

    public List<UserBoardBean.BoardItemInfo.PinsSimpleBean> getPins() {
        return pins;
    }
